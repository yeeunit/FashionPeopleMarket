...
export default function PointModalPage(props) {
    ...
    <>
      ...
      >
        <form>
          ...
          <br />
          {/* <button
             disabled = { !props.isBtnActive } type = "button" onClick = { props.handleSubmit(props.onClickPointSubmit) } isBtnActive = { props.isBtnActive }>충전하기</button> */}
        </form>
